        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-xl-9" >
                    ...
                    <div class="table-responsive" v-if="selectedFolder">
                                    ...
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <a href="#" class="dropdown-item" @click.prevent="editFile(file)"
                                                    data-toggle="modal" data-target="#createFileModal">Edit</a>
                                                <a href="#" class="dropdown-item"
                                                    @click.prevent="submitDeleteFile(file)">Delete</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
            ...
            <CreateFile :isEdit="isEdit" :file="selectedFile" :user_id="$page?.props?.user.id" :folders="folders.data"
