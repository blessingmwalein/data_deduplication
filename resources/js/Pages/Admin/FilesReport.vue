            ...
            <div class="row">
                    ...
                    <div class="card border-0">
                        ...
                        <ul id="myUL">
                            <li
                                ...
                                v-for="file in filesToLoop"
                                @click="selectedFile = file[1]"
                            >
                                <span class="caret"
                                    ><span
                                        ><i
                                            class="jstree-icon jstree-themeicon ti-file text-warning jstree-themeicon-custom mr-2"
                                        ></i></span
                                    >{{ file[1][0]?.data.name }}</span
                                >
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-xl-9" v-if="selectedFile">
                    <div class="content-title mt-0">
                        <h4>
                            Total Duplicate Files :{{ selectedFile.length }}
                        </h4>
                        <h6>Total Memory Saved:{{ calcTotalMemorySaved() }}</h6>
                        <button
                            class="btn btn-lg btn-block btn-outline-primary"
                            style="width: 200px" @click="downloadFile()"
                        >
                            <i class="fa fa-cloud-upload mr-3"></i> Download
                            Excel Report
                        </button>
                    </div>
                                ...
                                <tr v-for="file in selectedFile">
                                    ...
                                    <td>
                                        ...
                                        >
                                            ...
                                            >
                                                <span
                                                    class="avatar-title bg-warning rounded-pill"
                                                    >{{
                                                        getInitials(
                                                            file.data.user.name
                                                        )
                                    ...
                                    <td>
                                        <div
                                            class="badge bg-info-bright text-info"
                                        >
                                            {{ file.data.fileType }}
                                        </div>
                                    </td>
...
export default {
    ...
    methods: {
        //create function to dowload file
        downloadFile() {
            //get with inertia
            location.href = "/admin/downloadExcel";
        },
        selectFile(file) {
