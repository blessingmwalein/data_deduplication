                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-xl-2 col-md-3">
                            <figure>
                                <img class="img-fluid"
                                    src="https://filedash.laborasyon.com/demos/orange/assets/media/svg/upgrade.svg"
                                    alt="upgrade">
                            </figure>
                        </div>
                        <div class="col-xl-10 col-md-9">
                            <div
                                class="d-md-flex align-items-center justify-content-between text-center text-md-left p-4 p-md-0">
                                <div class="mr-3">
                                    <h4 class="mb-3">Get an Upgrade</h4>
                                    <p class="text-muted">Get additional 500 GB space for your documents and
                                        files. Expand
                        ...
                        <div class="card-body text-center">
                            <div class="row mb-4">
                                <div class="col-md-8 offset-md-2">
                                    <img src="https://filedash.laborasyon.com/demos/orange/assets/media/svg/report.svg"
                                        class="img-fluid" alt="report">
                                </div>
                            </div>
                            <h4 class="my-3">Create Report</h4>
                            <p class="text-muted">Create reports to grow their business and serve their
                                customers better. Use this tool to generate reports.</p>
                    ...
                    <div>
                        ...
                        <div class="row row-xs">
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sx-6">
                                <figure>
                                    <img src="/assets/media/image/portfolio-five.jpg" class="w-100 border-radius-1"
                                        alt="image">
                                </figure>
                            </div>
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sx-6">
                                <figure>
                                    <img src="/assets/media/image/portfolio-one.jpg" class="w-100 border-radius-1"
                                        alt="image">
                                </figure>
                            </div>
                            <div class="col-xl-2 col-lg-3 col-md-4 col-sx-6">
                                <figure>
                                    <img src="/assets/media/image/portfolio-three.jpg" class="w-100 border-radius-1"
                                        alt="image">
                                </figure>
                            </div>
                        </div>
